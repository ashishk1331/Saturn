...
export default function Modal(props){
	...
	return (
		<div className={cn("absolute inset-0 w-full h-full flex bg-color-500/50 backdrop-blur-sm z-50", !display ? 'hidden' : '')}>
			<div className="max-w-3/4 w-3/4 bg-[white] p-4 py-8 m-auto rounded-xl overflow-hidden flex flex-col gap-8">
				...
				<div className="relative px-4 w-full overflow-hidden rounded-xl">
					<img 
